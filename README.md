...
- **[Rhumb](https://github.com/supertrained/rhumb)** - Discover and score 600+ APIs for AI agents — [AN Score](https://rhumb.dev) rates services across 20 dimensions covering execution readiness and access patterns. 16 MCP tools, works without auth. [![Glama](https://glama.ai/mcp/servers/supertrained/rhumb/badge)](https://glama.ai/mcp/servers/nnimnpwgem)
